...
class MainWindow(QMainWindow):
    ...
    def update_ui(self, data):
        ...
        if text_result:
            text_label = QLabel(text_result); text_label.setWordWrap(True); text_label.setTextFormat(Qt.TextFormat.PlainText); text_label.setStyleSheet("font-family: Consolas, 'Courier New', monospace;"); self.image_layout.addWidget(text_label)
